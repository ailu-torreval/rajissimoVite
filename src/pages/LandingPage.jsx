...
function LandingPage() {
  ...
  return (
    <section className="bg-box flex justify-center items-center">
      <div className="bg-white p-1 mx-12 flex justify-between items-center flex-col gap-2 md:gap-4 rounded-[20px] sm:gap-1 sm:p-2 lg:p-14">
      <h3 className="text-blue max-w-[215px] sm:max-w-[350px] md:max-w-[650px] mb-[10px]">Please Add your address</h3>
      <AddressInputArea 
      addressAlert={addressAlert} 
      setAddressAlert={setAddressAlert} 
      />
      <BtnGrid
              class="flex flex-col sm:items-center gap-4 sm:gap-20 sm:flex-row mt-[10px]"
