  ...
  return (
    <OrderProdDataContext.Provider value={{ orderProdData, setOrderProdData }}>
      <div
        ...
        onClick={closePage}
      >
        <div className="bg-white md:w-[60vw] lg:w-[50vw] 2xl:w-[40vw] overflow-hidden border-2  border-yellow rounded-[35px] h-min relative" onClick={(e) => e.stopPropagation()}>
          <button
          ...
          <img className="md:w-full" src={prod[0].imgSrc} alt="" />
          </div>
          <div className="px-2">
