  ...
  return (
    <div className="bg-box flex justify-center items-center">
      {isProcessed ? (
          ...
          {orderForm.isDelivery ? (
            ...
            <>
              ...
              <p className="my-2">
                ...
                Frederiksberggade 32, 1459 København
              </p>
            </>
          )}
          <Btn
        ...
        <div className="bg-white rounded-[20px] flex flex-col justify-center items-center max-w-[220px] py-20 px-6 text-center sm:max-w-[450px] sm:px-28 sm:py-2 md:max-w-[888px] md:px-32 md:py-4 xl:px-72 xl:py-20 ">
          <div className="flex font-header justify-center items-center relative">
            {/* <span className="">➔</span> */}
            <img
              className="absolute p-8 text-4xl left-0 right-0 top-0"
              src={logo}
              alt=""
            />
            <svg
